...
<div class="settings-group">
  ...
  <div class="group-content">
    {#if showTagGroupSection}
      <div class="row">
        <div class="label-with-desc">
          <label for="irTagGroupPrior">{tagGroupPriorLabel ?? t('irSettings.tagGroupPriorLabel')}</label>
    ...
    {#if showTagGroupSection && settings.incrementalReading?.enableTagGroupPrior !== false}
      ...
      <div class="row">
        <div class="label-with-desc">
          <label for="irTagGroupFollowMode">{tagGroupFollowLabel ?? t('irSettings.tagGroupFollowLabel')}</label>
