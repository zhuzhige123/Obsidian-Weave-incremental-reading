...
export interface AnkiConnectSettings {
	...
	incrementalSyncState?: Record<string, unknown>;
	...
	// UI 状态缓存
	uiCache?: {
		ankiDecks: Array<Record<string, unknown>>;
		ankiModels: Array<Record<string, unknown>>;
		lastFetchTime: string;
		lastConnectionStatus?: Record<string, unknown>;
	};
