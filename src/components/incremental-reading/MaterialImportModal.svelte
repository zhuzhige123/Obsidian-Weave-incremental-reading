      ...
      <div class="step-content preview-step">
        ...
        {:else}
          <div class="preview-header">
            <button class="clickable-icon btn-icon" onclick={() => previewIndex = Math.max(0, previewIndex - 1)} disabled={previewIndex === 0}>
      ...
      <footer class="modal-footer modal-footer-preview">
        ...
        <div class="scheduling-selector">
            <div class="selector-row">
              ...
              {#if useCustomDays}
                ...
                />
              {/if}
              <button class="clickable-icon menu-trigger" onclick={showSchedulingStrategyMenu}>
                {getStrategyLabel()}
                <ObsidianIcon name="chevron-down" size={12} />
              </button>
        ...
        <div class="deck-selector">
            ...
            {#if showNewDeckInput}
              <div class="new-deck-input">
                ...
                />
                <button class="clickable-icon btn-icon-sm" onclick={handleCreateNewDeck} disabled={creatingDeck || !newDeckName.trim()}>
                  <ObsidianIcon name="check" size={14} />
                </button>
                <button class="clickable-icon btn-icon-sm" onclick={cancelNewDeck}>
                  <ObsidianIcon name="x" size={14} />
                </button>
              </div>
            {:else}
              <button class="clickable-icon menu-trigger deck-trigger" onclick={showDeckSelectMenu}>
        ...
        {#if shouldShowMarkdownImportFolderSelector()}
          <div class="deck-selector markdown-folder-selector">
            ...
            >
              <span class="clickable-icon menu-trigger-text">{getMarkdownImportFolderLabel()}</span>
              <ObsidianIcon name="chevron-down" size={12} />
            </button>
          </div>
        {/if}
