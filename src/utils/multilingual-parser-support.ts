...
export class MultilingualPatternRecognizer {
	...
	private initializePatterns(): void {
		...
		this.patterns.set("en", {
			...
			answerMarkers: ["Answer:", "A:", "Solution:", "Response:", "Reply:", "Explanation:"],
			separators: ["---", "===", "***", "Answer", "Solution"],
			questionWords: [
				"what",
				"how",
				"why",
		...
		this.patterns.set("ja", {
			questionMarkers: ["質問:", "問題:", "Q:", "問:", "何", "どう", "なぜ", "いつ", "どこ", "誰"],
			answerMarkers: ["答え:", "回答:", "A:", "解答:", "説明:", "解釈:"],
			separators: ["---", "===", "***", "答え", "回答"],
			questionWords: ["何", "どう", "なぜ", "いつ", "どこ", "誰", "どの", "どれ", "いくつ"],
			punctuation: ["？", "。", "！", "：", "；", "、"],
		});
		...
		this.patterns.set("ko", {
			...
			answerMarkers: ["답:", "답변:", "A:", "해답:", "설명:", "해석:"],
			separators: ["---", "===", "***", "답", "답변"],
			questionWords: ["무엇", "어떻게", "왜", "언제", "어디", "누구", "어느", "몇", "얼마"],
			punctuation: ["?", ".", "!", ":", ";", ","],
		});
	}
 ...
 * 便捷函数：创建默认的多语言识别器
 */
export function createMultilingualRecognizer(
