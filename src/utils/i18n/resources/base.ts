...
export const standaloneBaseTranslations: Record<SupportedLanguage, TranslationKey> = {
	'zh-CN': {
		common: {
			clearSearch: '清除搜索',
			commonPrefixes: '常用前缀',
	...
	'en-US': {
		...
		about: {
			license: {
				...
				activation: {
					...
					formDesc: 'Enter your activation code and purchase email to bind this device.',
					...
					confirmDeactivate: 'Deactivate this license on the current device? This will free one activation slot.',
		...
		settingsUtils: {
			...
			errors: {
				...
				invalidFormatSolution: 'Please check whether the activation code is complete and correctly formatted',
