...
const zhIrSettingsStandalone: TranslationKey = {
	...
	about: {
		...
		panelDescription: "集中查看当前增量阅读插件的基础信息、支持格式与核心能力。",
		pluginInfo: "插件信息",
		pluginName: "插件名",
		version: "版本号",
		series: "系列归属",
		...
		capabilityOverview: "增量阅读能力概览",
		supportedFormats: "支持格式",
		overview: "核心介绍",
		overviewValue:
			"支持阅读点与专题排期、增量阅读日历、多来源入队、每日上限与续读安排，并可联动 Weave 与 EPUB 阅读器完成读-排-记闭环。",
		contactsTitle: "联系方式",
		contacts: {
			website: "Weave 官网",
			changelog: "更新日志",
...
const enIrSettingsStandalone: TranslationKey = {
	...
	about: {
		...
		panelDescription:
			"Review the current incremental-reading plugin’s basic info, supported formats, and core capabilities in one place.",
		...
		capabilityOverview: "Incremental reading capability overview",
		supportedFormats: "Supported formats",
		overview: "Overview",
		overviewValue:
			"Supports reading points and topic scheduling, an incremental-reading calendar, multi-source intake, daily limits and resume planning, and works with Weave and the EPUB reader for a read–schedule–review loop.",
		contactsTitle: "Contact",
		contacts: {
			website: "Weave website",
			changelog: "Changelog",
