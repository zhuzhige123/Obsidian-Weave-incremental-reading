 ...
 * @returns CodeMirror 扩展
 */
export function obsidianPreviewToggleExtension(onTogglePreview: PreviewToggleCallback): Extension {
 ...
 * @returns CodeMirror 扩展
 */
export function adaptivePreviewToggleExtension(onTogglePreview: PreviewToggleCallback): Extension {
