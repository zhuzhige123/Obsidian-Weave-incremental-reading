...
export function getObsidianThemeColors() {
	...
	return {
		...
		backgroundModifierBorder:
			style.getPropertyValue("--background-modifier-border").trim() || "#e0e0e0",
		backgroundModifierBorderHover:
			style.getPropertyValue("--background-modifier-border-hover").trim() || "#d0d0d0",
		backgroundModifierBorderFocus:
			style.getPropertyValue("--background-modifier-border-focus").trim() || "#4a9eff",
		backgroundModifierHover:
			style.getPropertyValue("--background-modifier-hover").trim() || "#f0f0f0",
		...
		interactiveAccentHover:
			style.getPropertyValue("--interactive-accent-hover").trim() || "#6d28d9",
