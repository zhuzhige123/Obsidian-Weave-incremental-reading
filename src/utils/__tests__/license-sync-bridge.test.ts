...
import { resolveEffectiveLicenseState, cloneLicenseAsInherited, LICENSED_PRODUCTS } from "../license-state";
import type { LicenseInfo } from "../../types/license";

function createLicense(activationCode: string, entitlements: LicenseInfo["entitlements"] = ["ir-premium"]): LicenseInfo {
  return {
    activationCode,
    isActivated: true,
