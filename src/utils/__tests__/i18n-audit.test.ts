...
describe('i18n audit', () => {
  ...
  it('keeps cleared bilingual hotspots free of new hardcoded Chinese UI text', () => {
    ...
    const hotspotFiles = [
      ...
      'src/components/ai-assistant/EditorAICardToolbar.svelte',
      ...
      'src/components/ai-assistant/CardPreviewModal.svelte',
      ...
      'src/components/incremental-reading/IRCalendarSearchInput.svelte',
