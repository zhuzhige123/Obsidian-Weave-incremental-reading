...
export function createStandaloneIRTestApp(overrides: Record<string, unknown> = {}): Record<string, unknown> {
	const adapter = {
		...
		...(overrides.vault as { adapter?: Record<string, unknown> } | undefined)?.adapter,
	};
