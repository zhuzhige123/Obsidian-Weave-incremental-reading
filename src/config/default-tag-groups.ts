...
export const TAG_GROUP_CATEGORIES = {
	medical: {
		name: "医学",
		icon: "⚕️",
		groups: ["medical-circulatory", "medical-respiratory", "medical-digestive", "medical-nervous"],
	},
	programming: {
		name: "编程",
		icon: "💻",
	...
	language: {
		name: "语言",
		icon: "🌐",
		groups: ["language-english-grammar", "language-english-vocabulary", "language-japanese"],
	},
	exam: {
		name: "考试",
		icon: "📋",
		groups: ["exam-gaokao", "exam-postgraduate", "exam-professional"],
	},
	other: {
		name: "其他",
		icon: "✨",
		groups: ["finance-investment", "personal-development", "hobby-interests"],
	},
};
