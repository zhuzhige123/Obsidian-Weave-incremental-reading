 ...
 * 渐进式挖空卡片联合类型
 */
export type ProgressiveClozeCard = ProgressiveClozeParentCard | ProgressiveClozeChildCard;
 ...
 * 判断是否为子卡片实例（用于学习流程）
 */
export function isChildCardInstance(
	instance: StudyInstance
): instance is ProgressiveClozeChildCard {
