...
export interface QuestionTestStats {
	...
	/** 简单平均正确率 (0-1)
	 * Compatibility note: 使用 masteryMetrics.currentAccuracy 替代
	 * 仅保留用于向后兼容
	 */
	accuracy: number;
 ...
 * 题库考试会话恢复策略
 */
export type QuestionBankResumeBehavior = "prompt" | "resume" | "restart";
...
export interface TestHistoryQuestionSummary {
	questionId: string;
	isCorrect: boolean | null;
	answered: boolean;
