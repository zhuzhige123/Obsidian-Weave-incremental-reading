...
import type { SimplifiedParsingSettings } from "./newCardParsingTypes";
 ...
 */
export function isWeavePlugin(obj: unknown): obj is IWeavePlugin {
	return (
		typeof obj === "object" &&
		obj !== null &&
		"addCardsToDB" in obj &&
 ...
 */
export function isObsidianApp(obj: unknown): obj is IObsidianApp {
	return typeof obj === "object" && obj !== null && "vault" in obj;
}
